...
// Network Configuration - ĐÃ CẬP NHẬT
export const NETWORK_CONFIG = {
  // Base URL mới
  BASE_URL: 'https://viegrand.site/backend/',
...
// Hàm để lấy host dựa trên cấu hình - ĐÃ CẬP NHẬT
export const getAPIHost = (): string => {
  ...
  // Sử dụng base URL mới
  return 'viegrand.site';
};

// Hàm để lấy URL đầy đủ - ĐÃ CẬP NHẬT
export const getAPIURL = (): string => {
  // const host = getAPIHost();
  // return `http://${host}:${NETWORK_CONFIG.PORT}/api`;
  
  // Sử dụng base URL mới
  return NETWORK_CONFIG.BASE_URL;
};

// Debug info - ĐÃ CẬP NHẬT
export const getNetworkInfo = () => {
  return {
    platform: Platform.OS,
    // useLocalhost: NETWORK_CONFIG.USE_LOCALHOST,
    useLocalhost: false, // Tạm thời
    host: getAPIHost(),
    fullURL: getAPIURL(),
