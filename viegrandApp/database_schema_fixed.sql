-- =====================================================
-- VIEGRAND APP DATABASE SCHEMA - CORRECTED VERSION
-- =====================================================
...
ADD CONSTRAINT fk_user_sub_userId FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE,
ADD CONSTRAINT fk_user_sub_planId FOREIGN KEY (planId) REFERENCES premium_plans(id) ON DELETE CASCADE;

ALTER TABLE payment_transactions 
ADD CONSTRAINT fk_payment_userId FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE,
ADD CONSTRAINT fk_payment_subscriptionId FOREIGN KEY (subscriptionId) REFERENCES user_subscriptions(id) ON DELETE CASCADE,
ADD CONSTRAINT fk_payment_planId FOREIGN KEY (planId) REFERENCES premium_plans(id) ON DELETE CASCADE;

ALTER TABLE user_settings 
ADD CONSTRAINT fk_settings_userId FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE;

ALTER TABLE elderly_relatives 
ADD CONSTRAINT fk_elderly_elderlyId FOREIGN KEY (elderlyId) REFERENCES users(id) ON DELETE CASCADE,
ADD CONSTRAINT fk_elderly_relativeId FOREIGN KEY (relativeId) REFERENCES users(id) ON DELETE CASCADE;

ALTER TABLE emergency_contacts 
ADD CONSTRAINT fk_emergency_userId FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE;

ALTER TABLE notifications 
ADD CONSTRAINT fk_notification_userId FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE;

ALTER TABLE health_records 
ADD CONSTRAINT fk_health_userId FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE;
...
BEGIN
    DECLARE v_expiredCount INT DEFAULT 0;
    ...
    SELECT v_expiredCount as expiredCount;
END$$
DELIMITER ;
...
/*
VIEGRAND APP DATABASE SCHEMA - VERSION 1.0

✅ Đã sửa lỗi MariaDB syntax
✅ Loại bỏ DEFAULT parameter trong stored procedure
✅ Tách riêng FOREIGN KEY constraints
✅ Sử dụng DELIMITER $$ cho stored procedures
✅ Xử lý lỗi duplicate procedures

Cách sử dụng:
1. Chạy script này để tạo database hoàn chỉnh
2. Import sample_data_safe.sql để có dữ liệu test
3. Sử dụng premium.php để test APIs
